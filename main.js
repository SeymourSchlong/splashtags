...
const load = () => {
    ...
    waitUntil(() => {
        if (!loadQueue.length) {
            ...
            // I'm sure all of the "on change" events can be simplified, but as of right now, not necessary
